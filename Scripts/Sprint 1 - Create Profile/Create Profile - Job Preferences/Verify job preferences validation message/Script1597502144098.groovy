...
WebUI.waitForElementVisible(findTestObject('Object Repository/Job Seeker Job Preferences OR/Career level validation'), 5)

WebUI.waitForElementVisible(findTestObject('Object Repository/Job Seeker Job Preferences OR/Employment type validation'), 5)
