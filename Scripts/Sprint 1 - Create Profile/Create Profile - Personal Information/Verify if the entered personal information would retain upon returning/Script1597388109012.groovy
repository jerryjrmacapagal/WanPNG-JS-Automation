...
int randomCities = new Random().nextInt(cities.length + 1)

WebUI.setText(findTestObject('Object Repository/Jobseekers Personal Info OR/City or village textbox'), findTestData('Cities').getValue('Cities', randomCities))
