...
WebUI.click(findTestObject('Object Repository/Jobs page OR/Job Classifications/Job classification Construction'))

WebUI.click(findTestObject('Object Repository/Jobs page OR/Job Classifications/Job classification Information and Communication Technology'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Job search OR/3 job classifications'), "3 Job classifications")
