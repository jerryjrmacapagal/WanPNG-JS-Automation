...
//SCENARIO 2: Verify if the notification counter is displayed upon receiving notifications
...
//SCENARIO 3: Verify if the "Red Dot" / Unread icon is displayed when the notification is not yet clicked / read
