...
//SCENARIO 1: Verify if jobseeker can open the notification in new tab
...
//SCENARIO 2: Verify if jobseeker can open the notification in new window
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Notification Page OR/Notification pop over content'), 5)
