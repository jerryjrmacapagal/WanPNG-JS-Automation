...
WebUI.waitForElementPresent(findTestObject('Object Repository/Jobs page OR/Active applications'), 5)

WebUI.click(findTestObject('Object Repository/Jobs page OR/Active applications'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Jobs page OR/Closed applications'), 5)

WebUI.click(findTestObject('Object Repository/Jobs page OR/Closed applications'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Jobs page OR/Closed Jobs Filter OR/First Closed Job Card'), 5)
