...
//execute testcase
WebUI.waitForElementPresent(findTestObject('Object Repository/Job Seeker Skills and Competencies OR/Done button'), 5)

WebUI.click(findTestObject('Object Repository/Job Seeker Skills and Competencies OR/Done button'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Job Seeker Skills and Competencies OR/Skill and competency validation'), 5)
...
WebUI.verifyElementText(findTestObject('Object Repository/Job Seeker Skills and Competencies OR/Skill and competency validation'), GlobalVariable.skillValidationMessage)
