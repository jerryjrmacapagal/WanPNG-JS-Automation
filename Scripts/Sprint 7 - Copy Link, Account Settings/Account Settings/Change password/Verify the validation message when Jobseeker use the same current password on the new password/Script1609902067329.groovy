...
WebUI.waitForElementPresent(findTestObject('Object Repository/Jobseeker Account Settings/Input Current password'), 5)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Jobseeker Account Settings/Please enter a password different from your current one'), 5)

WebUI.verifyElementText(findTestObject('Object Repository/Jobseeker Account Settings/Please enter a password different from your current one'), GlobalVariable.sameNewPasswordValidation)
