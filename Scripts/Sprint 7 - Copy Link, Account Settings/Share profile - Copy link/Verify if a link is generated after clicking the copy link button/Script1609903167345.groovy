...
WebUI.waitForElementPresent(findTestObject('Object Repository/Jobseekers CV Template/Copy link button'), 10)

WebUI.click(findTestObject('Object Repository/Jobseekers CV Template/Copy link button'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Copy link OR/Copy link modal'), 5)
