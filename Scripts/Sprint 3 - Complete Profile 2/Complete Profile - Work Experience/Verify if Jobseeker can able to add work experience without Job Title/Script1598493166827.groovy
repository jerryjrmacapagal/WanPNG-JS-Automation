...
WebUI.waitForElementPresent(findTestObject('Object Repository/Jobseekers Add Work Experience/Job title is required'), 5)

WebUI.verifyElementText(findTestObject('Object Repository/Jobseekers Add Work Experience/Job title is required'), GlobalVariable.jobTitleValidation)
