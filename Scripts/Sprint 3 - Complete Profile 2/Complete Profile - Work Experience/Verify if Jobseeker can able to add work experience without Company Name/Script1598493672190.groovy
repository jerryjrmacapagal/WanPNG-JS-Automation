...
WebUI.waitForElementPresent(findTestObject('Object Repository/Jobseekers Add Work Experience/Company name is required'), 5)

WebUI.verifyElementText(findTestObject('Object Repository/Jobseekers Add Work Experience/Company name is required'), GlobalVariable.companyNameValidation)
