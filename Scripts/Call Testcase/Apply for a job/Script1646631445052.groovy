...
WebUI.verifyElementPresent(findTestObject('Object Repository/Job Preview OR/Employer Details/Apply now button'), 5)

WebUI.click(findTestObject('Object Repository/Job Preview OR/Employer Details/Apply now button'))
