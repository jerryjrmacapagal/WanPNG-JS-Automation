...
WebUI.waitForElementPresent(findTestObject('Object Repository/Jobs page OR/Job Classifications/Job classification Information and Communication Technology'), 5)
