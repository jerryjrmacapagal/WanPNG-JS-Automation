...
WebUI.verifyElementText(findTestObject('Object Repository/Jobs page OR/Saved jobs title'), GlobalVariable.saveJobsTitle)

WebUI.verifyElementPresent(findTestObject('Object Repository/Jobs page OR/Saved jobs section'), 5)
