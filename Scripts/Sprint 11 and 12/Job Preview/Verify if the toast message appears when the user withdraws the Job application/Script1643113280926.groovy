...
WebUI.verifyElementText(findTestObject('Object Repository/Jobs page OR/Withdraw application modal/Withdraw pop up message'), GlobalVariable.withdrawPopUpMessage)
